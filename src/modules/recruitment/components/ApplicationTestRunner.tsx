...
interface Props {
  ...
  testId: string;
  testSlug: string;
  /** Nome exibido do teste. Vem do cadastro (admission_tests), não da
      definição local — TestDefinition só carrega as perguntas. */
  testName: string;
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-sm">
          {onCancel ? (
            ...
            <span className="text-muted-foreground font-medium">{testName}</span>
          )}
